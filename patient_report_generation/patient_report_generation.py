...
OUTPUT_FILE = "kbg_final_patient_reports.jsonl"
        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Give information and recommendations from the clinical reference guidlines only."
                    "Your output MUST strictly follow this exact 12-category markdown scheme. Do not include any introductory or concluding text outside of this schema:\n\n"
                    "# CLINICAL PATIENT REPORT\n\n"
                    "## 1) RESPIRATORY\n"
                    "a) How this affects the patient:\n"
                    "b) Information from the guidelines:\n"
                    "c) Recommendations for screening or intervention:\n\n"
                    "## 2) CARDIOLOGY\n"
                    "a) How this affects the patient:\n"
                    "b) Information from the  guidelines:\n"
                    "c) Recommendations for screening or intervention:\n\n"
                    ...
                    "b) Information from the guidelines:\n"
                    "c) Recommendations for screening or intervention:\n\n"
                    " ### CRITICAL CONDITIONAL FORMATTING RULE:"
                    " For any of the 12 medical categories where the parent explicitly reports NO active symptoms, difficulties, or concerns in the transcript, you MUST bypass standard processing and output these exact phrases word-for-word:"
                    "- Under section a), write exactly: No active symptoms or difficulties reported."
                    "- Under section b), write exactly: No active symptoms or difficulties reported."
                    "- Under section c), write exactly: No Recommendations."
                    "DO NOT invent symptoms, do not extrapolate, and do not pull general screening guidelines from the reference text for any category that the parent confirms is unaffected."

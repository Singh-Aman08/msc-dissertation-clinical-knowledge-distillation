...
ADAPTER_PATH = "weighted_sft_qwen25_1.5b/checkpoint-50"
INPUT_FILE = "training_consultation_dpo_10.jsonl"
OUTPUT_FILE = "patient_report_weighted_sft_qwen25_1.5b_DPO_50_10.jsonl"
...
with open(INPUT_FILE, "r", encoding="utf-8") as infile:
    ...
    for line in infile:
        ...
        patient_id = record.get("index", conversation_count)

...
# IMPORTANT:
# This DPO run updated the SFT LoRA directly.
# Therefore checkpoint-50 already contains the SFT + DPO-trained
# adapter weights.
DPO_CHECKPOINT_PATH = "qwen25_1.5b_dpo_wght_conservative/checkpoint-40"

INPUT_FILE = "testing_consultations_06.jsonl"
OUTPUT_FILE = "patient_report_wgt_dpo_06.jsonl"
...
# ============================================================
# LOAD DPO-TRAINED ADAPTER
# ============================================================

print("\nLoading DPO checkpoint...")

print(DPO_CHECKPOINT_PATH)
...
print("\nPipeline:")
print("Base Qwen 1.5B")
print("      ↓")
print("SFT LoRA")
print("      ↓")
print("DPO training")
print("      ↓")
print("DPO checkpoint-50")
print("      ↓")
print("Inference")

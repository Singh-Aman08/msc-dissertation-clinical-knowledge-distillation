...
OUTPUT_FILE = "patient_report_teacher_model_06.jsonl"
...
# Number of reports used only for computational benchmarking
N_BENCHMARK = 10

# Keep this identical to your original generation setting
MAX_NEW_TOKENS = 2048

# Output file for benchmark results
BENCHMARK_OUTPUT = "teacher_model_computational_efficiency.csv"
...
print("=" * 70)
print("TEACHER MODEL COMPUTATIONAL EFFICIENCY BENCHMARK")
print("=" * 70)

print(f"Model:              {MODEL_ID}")
print(f"Benchmark reports:  {N_BENCHMARK}")
...
print(
    f"Total parameters (B): "
    f"{total_parameters / 1e9:.3f} B"
)
...
if len(records) == 0:
    raise RuntimeError("No consultations were loaded from the input file.")
...
warmup_transcript = warmup_record.get(
...
# ============================================================
# ORIGINAL PROMPT — PASTE YOUR EXACT PROMPT HERE
# ============================================================
...
"""
            ...
            },
            {
                    ...
                    "content": (
                        ...
                        f"=== VERBATIM DOCTOR-PARENT CONVERSATION ===\n"
                        f"{warmup_transcript}\n\n"
                        "Generate the complete clinical report following the strict "
                        "13-category schema layout."
                    )
                }
        ]
...
# Make sure all GPU operations are finished
for device_id in range(torch.cuda.device_count()):
    torch.cuda.synchronize(device_id)


# Clear temporary generation memory
torch.cuda.empty_cache()
...
for i, record in enumerate(records, start=1):
    ...
    # ========================================================
    # PEAK GPU MEMORY ACROSS ALL GPUs
    # ========================================================
...
print("\n" + "=" * 70)
print("TEACHER COMPUTATIONAL EFFICIENCY RESULTS")
print("=" * 70)
...
mean_tokens = np.mean(generated_tokens)

...
SYSTEM_PROMPT = """You are a strict, highly specialized clinical report evaluator. Your sole assignment is to audit ONLY the COVERAGE of a generated clinical patient report against the provided source contexts. 
...
Analyze the coverage matching profiles across the 3 aspects. 
Output the final evaluation strictly inside the markdown ```json ``` block format as specified."""
        ...
        test_payload = {
            "index": idx,
            "coverage_evaluation": parsed_json
        }
